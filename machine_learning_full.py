...
print("Machine learning with all features, changed number of folds, and +/- negative!")
data = pd.read_csv('all_merged_v2.csv')
data.head()
...
for name, (model, params) in models_dict.items():
    ...
    print(f"Stored best {name} model for SHAP ↩︎")
